...
export function normalizePayload(payload) {
  ...
  // Only genuine UTM keys — GoKwik's top-level `source` describes the delivery
  // channel ("gokwik-abc-webhook-test"), not a marketing source.
  const utmSource = pick(p, ['utm_source', 'origin_referrer', 'utm.source']);
